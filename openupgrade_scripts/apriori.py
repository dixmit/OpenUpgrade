...
renamed_modules = {
    ...
    # OCA/...
    # CB Changes
    "storage_backend_wsr_files": "fs_storage_cb",
}
...
merged_modules = {
    ...
    "medical_administration_practitioner": "medical_base",
    "storage_backend": "fs_storage",
    "sale_commission_formula": "commission",
    "quality_control_mrp_oca": "base",
    "webservice": "web",
    "pos_inter_company": "point_of_sale",
    "pos_multiple_sessions": "point_of_sale",
    "web_flagbox": "web",
    "quality_control_oca": "base",
    "quality_control_stock_oca": "base",
    "l10n_es_iva_soportado_no_deducible": "l10n_es",
    "cb_l10n_es_aeat_mod303": "l10n_es_aeat_mod303",
    "iot_ras_oca": "iot_oca",
    "cb_number_of_holidays_report": "hr",
    "web_widget_child_selector": "web",
    "mail_broker": "mail",
    "web_view_calendar_list": "web",
    "l10n_es_iva_incluido": "l10n_es",
    "maintenance_request_custom_info": "maintenance",
    "kpi_dashboard": "web",
    "mail_broker_telegram": "mail",
    "cb_hr_dms": "hr",
    "base_gs1_barcode": "base",
    "stock_barcodes_gs1": "stock",
    "stock_barcodes_gs1_expiry": "stock",
    "stock_barcodes_gs1_configurator": "stock",
    "storage_backend_sftp": "fs_storage",
    "storage_file": "fs_storage",
    "storage_backend_multicompany": "fs_storage",
    "base_rest_datamodel": "base",
    "datamodel": "base",
    "base_rest": "base",
    "edi_webservice_oca": "edi_oca",
    "account_invoice_google_document_ai": "account",
    "mgmtsystem_indicators_report_pdf2data_import": "mgmtsystem_indicators_report",
    "edi_pdf2data_oca": "edi_oca",
    "medical_his": "medical_base",
    "l10n_es_account_import_facturae_purchase": "l10n_es",
    "l10n_es_account_import_facturae": "l10n_es",
}
